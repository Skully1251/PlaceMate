...
function BehavioralInterviewPage({ language, onEndInterview }) {
    ...
    const initializeBehavioralInterview = async () => {
        ...
        const systemPrompt = getBehavioralSystemPrompt(language);
        const history = [
...
const callBackendAPI = async (history) => {
    ...
    return (
        <div className="animate-fade-in">
            <div className="bg-white/70 backdrop-blur-xl border border-white/30 rounded-2xl p-6 md:p-8 shadow-2xl max-w-3xl mx-auto">
                ...
                <div className="bg-slate-50/50 rounded-lg p-6 mb-6 min-h-[150px]">
                    {isLoading ? (
                        <div className="flex items-center justify-center">
                            <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-green-600"></div>
                            <span className="ml-3 text-slate-600">Thinking...</span>
                        </div>
                    ) : (
                ...
                <div className="flex flex-col items-center space-y-4">
                    ...
                    {interviewComplete && (
                        <button
                            ...
                            disabled={isLoading}
                            className="bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white font-bold py-4 px-8 rounded-full shadow-lg transition-all transform hover:scale-105 disabled:opacity-50"
                        >
...
const getBehavioralSystemPrompt = (lang) => `
...
3.  **Goal**: Assess the candidate's soft skills, work ethic, problem-solving approach, teamwork, and cultural fit. Ask a total of 5 behavioral questions.
...
5.  **Question Types**: Ask questions about past experiences, conflict resolution, teamwork, leadership, challenges, and achievements. Use the STAR method evaluation framework.
...
8.  **Conclusion**: After the 5th question, provide a brief concluding remark, thank the candidate, and tell them they can now access their feedback.
