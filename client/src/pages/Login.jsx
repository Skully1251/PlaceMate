...
function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-950 via-indigo-950 to-purple-950 p-4 relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[40%] bg-blue-400/30 rounded-full blur-[100px]"></div>
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-orange-400/30 rounded-full blur-[100px]"></div>
      ...
      <div className="bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl rounded-3xl p-8 sm:p-12 w-full max-w-md relative z-10 text-white">
        <div className="text-center mb-8">
          <h2 className="text-3xl font-black mb-2 drop-shadow-md">Welcome Back</h2>
        ...
        <p className="mt-8 text-center text-sm text-white/60">
          ...
          <Link to="/signup" className="text-white hover:text-violet font-semibold transition-colors">
            Sign up
          </Link>
        </p>
      </div>
